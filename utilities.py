...
def draw_text(surf,text, color,x,y,font):
...
class TextInput:
    ...
    def __init__(self,  initial_string="",
        ...
        Args:
            ...
            font_family: Name or path of the font that should be used. Default is pg-font
        ...
        if not os.path.isfile(font_family): font_family = pg.font.match_font(font_family)
